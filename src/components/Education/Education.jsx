        ...
        <div id="education" className="education">
            ...
            <div className="education-card-row">
                <div id="masters" className="degree">
                    <img src="images/umd.webp" alt="University of Maryland" className="degree-img" loading="lazy" />
                ...
                <div id="bachelors" className="degree">
                    <img src="images/vit.webp" alt="Vellore Institute of Technology" className="degree-img" loading="lazy" />
                    <div className="degree-header">
